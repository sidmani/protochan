...
namespace Shavite {
  ...
  function shaviteClose(ctx, ub, n) {
    var buf;
    var ptr, u;
    var z;
    ...
    var countBytes = Helper.int32Buffer2Bytes(countSwapped);
